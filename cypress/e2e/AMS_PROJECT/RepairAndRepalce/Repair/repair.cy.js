...
describe('Testing for Repair Section', () => {
    ...
    it.only('Adding Data for repair', () => {
        ...
        // Product Code
        cy.get(':nth-child(2) > .input__field > .toggle__showHide--container > .input-enabled').type('509')

        // Product Name
        cy.get(':nth-child(3) > .input__field > .toggle__showHide--container > .input-enabled').type('mac book pro')
       ...
       cy.get(':nth-child(4) > .input-enabled').select('Furniture')
        ...
        cy.get(':nth-child(6) > .input__field > .toggle__showHide--container > .input-enabled').type('Reason')
    ...
    it('Adding Data without product owner', () => {
        ...
        // Product Code
        cy.get(':nth-child(2) > .input__field > .toggle__showHide--container > .input-enabled').type('503')
