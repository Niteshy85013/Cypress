...
describe('Testing for procurement Section',()=>{
    ...
    it.only('Adding valid data',()=>{
        ...
        // Requested By
        cy.get('.procurement__employee--dets > :nth-child(1) > select').then(dropdown => {
        ...
        // Product Name
        cy.get('[data-cell="Product Name"] > .input__field > .toggle__showHide--container > .input-enabled').type(productname)
        ...
        // Product Link
        cy.get('[data-cell="Link"] > .input__field > .toggle__showHide--container > .input-enabled').type('www.google.com')

        // Save Product Button
        cy.get('.edit__button').click()

        //Fill procurement Button
        cy.get('.procurement__bottom--buttons > .procurement--button').should('be.visible').click()
        cy.wait(2000)
    ...
    it('Adding valid data',()=>{
        ...
        cy.get('.procurement__product--list > .procurement--button').should('be.visible').click()

        cy.wait(2000)
        // Product Name
        cy.get(':nth-child(2) > [data-cell="Product Name"] > .input__field > .toggle__showHide--container > .input-enabled').type(productname)

        cy.wait(3000)
        // Selecting Category
        cy.get(':nth-child(2) > [data-cell="Category"] > div > .input-enabled').then(dropdown => {
            const options = dropdown.find('option:not(:first)')
        ...
        // Brand Name
        cy.get(':nth-child(2) > [data-cell="Brand"] > .input__field > .toggle__showHide--container > .input-enabled').type(brandname)

        // Price
        cy.get(':nth-child(2) > [data-cell="Estimated Price"] > .input__field > .toggle__showHide--container > .input-enabled').type('$1000')

        // Product Link
        cy.get(':nth-child(2) > [data-cell="Link"] > .input__field > .toggle__showHide--container > .input-enabled').type('www.google.com')
